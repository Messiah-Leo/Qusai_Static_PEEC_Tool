...
void Save_PEEC_Circuit()
{
	...
	// 构造路径
	std::string Cir_Save_Path = PATH + "CirNetList.txt";
...
int Save_Netlist() {
	...
	std::string inputFile = PATH + "CirNetList.txt";
	std::string outputFile = PATH + "CirNetList.sp";
