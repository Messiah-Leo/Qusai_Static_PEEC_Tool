...
//输入文件相关常量
extern std::string PATH;                           //路径
extern std::string FUSION_SET_FILE;
// 类型相关的常量数组
...
extern double MAX_ERROR;                        // 误差上界
extern long long MAX_FREQ;                      // 频率上界
extern int MAX_NODE;                            //最大吸收节点数量
...
extern std::vector<std::vector<double>> A, AT;
extern int M_SZ;
#endif    // Global
