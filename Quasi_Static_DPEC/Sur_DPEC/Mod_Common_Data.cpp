...
// Definition of global variables declared as extern in header
std::string PATH; // 输入文件路径，全局变量，在运行时由 Read_Path() 设置
std::string FUSION_SET_FILE;
...
double MAX_ERROR;                        // 误差上界
long long MAX_FREQ;                      // 频率上界
int MAX_NODE;                            //最大吸收节点数量
